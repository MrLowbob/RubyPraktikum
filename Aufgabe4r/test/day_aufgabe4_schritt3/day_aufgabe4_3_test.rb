...
class DayTest < Test::Unit::TestCase
  ...
  def test_to_s
    ...
    assert_equal("DaySym[Di]", DS[:Di].to_s) # ist das gewollt, dass die Doppelpunkte vom Symbol
    assert_equal("DayIndex[2]", DI[2].to_s)  #verschwinden? oder hat das lediglich was mit der to_s 
  end                                        #funktion von Symbols zu tun?
